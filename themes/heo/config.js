const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-07-15', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    // { title: '欢迎来到我的博客', url: 'https://blog.rainvice.com' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'RAINVICE.COM',
  HERO_TITLE_4: '新版上线',
  ...
  INFO_CARD_URL: 'https://github.com/RainVice', // 个人资料底部按钮链接
